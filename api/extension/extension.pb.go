...
var fileDescriptor_2d065b70573ae483 = []byte{
	...
	0x9a, 0xa5, 0x2c, 0xb9, 0xb8, 0x91, 0x84, 0x49, 0x71, 0x9c, 0x51, 0x0e, 0x97, 0x00, 0xdc, 0x86,
	0xe0, 0xd4, 0xa2, 0xb2, 0xcc, 0xe4, 0x54, 0xa1, 0x08, 0x90, 0x18, 0xaa, 0xe5, 0x42, 0x8a, 0x04,
	0xc3, 0x4f, 0x4a, 0x91, 0xa0, 0xe3, 0x9d, 0x78, 0xa3, 0xb8, 0xf5, 0xac, 0xe1, 0xaa, 0x92, 0xd8,
	0xc0, 0x11, 0x6d, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x21, 0xff, 0x67, 0x14, 0xfb, 0x01, 0x00,
	0x00,
}
...
type ExtensionServiceClient interface {
	ExecuteExtension(ctx context.Context, in *ExecuteExtensionParams, opts ...grpc.CallOption) (*ExecuteExtensionOutput, error)
}
...
func (c *extensionServiceClient) ExecuteExtension(ctx context.Context, in *ExecuteExtensionParams, opts ...grpc.CallOption) (*ExecuteExtensionOutput, error) {
	out := new(ExecuteExtensionOutput)
	err := c.cc.Invoke(ctx, "/extension.ExtensionService/ExecuteExtension", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ExtensionService_ExecuteExtension_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteExtensionParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExtensionServiceServer).ExecuteExtension(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/extension.ExtensionService/ExecuteExtension",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExtensionServiceServer).ExecuteExtension(ctx, req.(*ExecuteExtensionParams))
	}
